...
#TODO: only mysql seems to need auto_reconnect for now. Postgres and sqlite do not end sessions.
sub _build_dbh {
  my $self = $_[0];
  my $opts = {
    AutoCommit => 1,
...
#TODO: oproepen van dbh IN de callback stoppen! (anders werk je met verouderde/dode connectie)
